...
TABLE_NAME = 'GA_ActiveUsers_DS_Web'
INDX = 'ga_activeusers_ds_web'
...
def main():
    ...
    for i in range((limit_date - ref_date).days - 1):
        ...
        df_part1 = active_users.fetch_data_daily(VIEW_ID, analytics, step_time.strftime('%Y-%m-%d'), 'web')
        ...
        df_part3 = active_users.fetch_data_custom_wrapper(VIEW_ID, analytics, custom_start,
                                                          step_time, 'monthlyUsersJalali', 'web')
        df_part4 = active_users.fetch_data_custom_wrapper(VIEW_ID, analytics,
                                                          step_time + relativedelta(days=-29),
                                                          step_time, '30DaysWindow', 'web')
